...
public class Timing {
     ...
     */
    public void timeProblem(CocoProblem problem) {

        if ((problem == null) || (this.previousDimension != CocoJNIReflectionWrapper.cocoProblemGetDimension(problem.getPointer()))) {
            ...
            if (problem != null) {
                ...
                this.previousDimension = CocoJNIReflectionWrapper.cocoProblemGetDimension(problem.getPointer());
                this.cumulativeEvaluations = CocoJNIReflectionWrapper.cocoProblemGetEvaluations(problem.getPointer());
                this.startTime = System.nanoTime();
            }
